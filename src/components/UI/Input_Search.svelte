...
<label for={inputId} type='search' class:hideIt="{hideLabel === true}"><span>{label}</span>
    {#if required}
...
<input type='search' id={inputId} bind:value={val} {required} placeholder={placeholder}  autocomplete={autocomplete}	
